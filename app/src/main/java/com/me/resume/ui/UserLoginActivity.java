...
public class UserLoginActivity extends BaseActivity implements
	...
	protected void onResume() {
		...
		if (preferenceUtil.getPreferenceData(UserInfoCode.SAVEPWD)) {
			...
			save_checkbox.setBackgroundResource(R.mipmap.checkbox_sel);
		}else{
			edtTxt_password.setText("");
			save_checkbox.setBackgroundResource(R.mipmap.checkbox_nor);
		}
	}
	...
	public void onClick(View view) {
		...
		case R.id.proto_checkbox:
			...
			if (agreeProtocol) {
				proto_checkbox.setBackgroundResource(R.mipmap.checkbox_sel);
			} else {
				proto_checkbox.setBackgroundResource(R.mipmap.checkbox_nor);
			}
			break;
		case R.id.protocol:
